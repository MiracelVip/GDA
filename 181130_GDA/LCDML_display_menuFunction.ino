...
// *********************************************************************
  ...
  // Time Calculation
    ...
    full = false;
    attachInterrupt(digitalPinToInterrupt(sensor_bottle), bottle_full, LOW);
...
// *********************************************************************
void manual_fill(uint8_t param)
// *********************************************************************
{
  if(LCDML.FUNC_setup())          // ****** SETUP *********
  {
...
// *********************************************************************
void manual_pressure(uint8_t param)
// *********************************************************************
{
  if(LCDML.FUNC_setup())          // ****** SETUP *********
  {
  ...
  if(LCDML.FUNC_loop())           // ****** LOOP *********
  {
    ...
    Serial.print(" startMillis: ");Serial.println(startMillis);
     ...
     if ((currentMillis - startMillis) <  g_para_14){
        lcd.setCursor(0, 0);
        lcd.print(F("* Druck ab -- *  "));
        digitalWrite(ventil_bier, LOW);
        digitalWrite(ventil_co2, LOW);
