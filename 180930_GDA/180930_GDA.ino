...
// *********************************************************************
    ...
    OneButton button_start(20, false);
    OneButton button_stop(21, true);
    OneButton button_abblasen(39, true);
    OneButton button_man_fill(37, true);
    OneButton button_man_druck(35, true);

    const int led_r = 53;
    const int led_g = 51;
    
    const int ventil_bier = 40;
    const int ventil_co2 = 42;
    const int ventil_co2_ab_l = 44;
    const int ventil_co2_ab_s = 46;
// *********************************************************************
// Objects
// *********************************************************************
...
// *********************************************************************
  ...
  LCDML_add         (5  , LCDML_0_2       , 4  , "Back/test"             , automatic_filling);
