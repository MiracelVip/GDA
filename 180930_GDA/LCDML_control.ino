...
// settings
  unsigned long g_LCDML_DISP_press_time = 1000;
  ...
  #define _LCDML_CONTROL_digital_enter           31
  #define _LCDML_CONTROL_digital_up              29
  #define _LCDML_CONTROL_digital_down            25
  #define _LCDML_CONTROL_digital_quit            11
  #define _LCDML_CONTROL_digital_left            23
  #define _LCDML_CONTROL_digital_right           27
// *********************************************************************
void lcdml_menu_control(void)
{
  // If something must init, put in in the setup condition
